...
/*
 * Modified version of keysym2ucs.c:
 * Author: Markus G. Kuhn <mkuhn@acm.org>, University of Cambridge, April 2001
 *
 * Special thanks to Richard Verhoeven <river@win.tue.nl> for preparing
 * an initial draft of the mapping table.
 *
 * http://cgit.freedesktop.org/xorg/xserver/tree/hw/xquartz/keysym2ucs.c
 */
...
/* original keysymtab sorted by ucs */
static const struct codepair reverse_keysymtab[] = {
    ...
    { 0x04c2, 0x30c4 }, /*                    kana_TSU ツ KATAKANA LEsyntaxTTER TU */
...
{
    int min = 0;
    int max = sizeof(reverse_keysymtab) / sizeof(struct codepair) - 1;
    int mid;
...
vk_send (PyObject *_self, PyObject *args, int mode)
{
    ...
    switch (mode) {
        ...
        case VK_SEND_MOD_UNLATCH:
            mod_mask = input;
            break;

        case VK_SEND_MOD_LOCK:
            press = true;
            lock = true;
            mod_mask = input;
            break;

        case VK_SEND_MOD_UNLOCK:
            lock = true;
            mod_mask = input;
            break;
...
static PyObject *
osk_virtkey_press_keycode (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_KEYCODE_PRESS);
}

static PyObject *
osk_virtkey_release_keycode (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_KEYCODE_RELEASE);
}
...
static PyObject *
osk_virtkey_lock_mod (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_MOD_LOCK);
}

static PyObject *
osk_virtkey_unlock_mod (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_MOD_UNLOCK);
}

static PyObject *
osk_virtkey_latch_mod (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_MOD_LATCH);
}

static PyObject *
osk_virtkey_unlatch_mod (PyObject *self, PyObject *args)
{
    return vk_send (self, args, VK_SEND_MOD_UNLATCH);
}
